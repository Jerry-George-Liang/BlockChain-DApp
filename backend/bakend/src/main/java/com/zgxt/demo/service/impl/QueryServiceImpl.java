...
import com.zgxt.demo.mapper.ReceiptMapper;
import com.zgxt.demo.model.Receipt;
import com.zgxt.demo.model.Result;
import com.zgxt.demo.model.vo.*;
...
public class QueryServiceImpl implements IQueryService {
    ...
    public Result listAllReceipt(String userAddress) {
        ...
        for(int i=1;i<=receiptIndex;i++) {
            ...
            receipt.setReceiptType(receiptVO.getReceiptType());
            receipt.setAmount(receiptVO.getAmount());
            receipt.setAccepterAddress(receiptVO.getAccepterAddress());
            receipt.setSenderAddress(receiptVO.getSenderAddress());
            receipt.setTransferType(receiptVO.getTransferType());
